...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < salespersoncount; i++) {
            ...
            //salesPersonList.get(i).achievementStatus(salesPersonList.get(i).getTotalweeklysales());
        ...
        for (int i = 0; i < managerList.size(); i++) {
            ...
            for (int j = 0; j < managerList.get(i).getManagingemployees().size(); j++) {
                ...
                for (int k = 0; k < managerList.get(i).getManagingemployees().get(j).getTotalweeklysales().size(); k++) {
                    ...
                    //int status;
                    //status = Boolean.parseBoolean(managerList.get(i).getManagingemployees().get(j).achievementStatus().get(k);
